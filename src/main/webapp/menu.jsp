	<div class="sidenav" id="menu">
		<a href="<%=request.getContextPath()%>/nova-turma" target="_self">Cadastrar Turma</a>
  		<a href="<%=request.getContextPath()%>/listar-turmas" target="_self">Turmas</a>
  		<a href="<%=request.getContextPath()%>/nova-disciplina" target="_self">Cadastrar Disciplina</a>
		...
		<a href="<%=request.getContextPath()%>/inicio" target="_self">Sair</a>
	</div>