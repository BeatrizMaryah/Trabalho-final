	<div class="sidebar">
        ...
        <ul class="nav-list">
            <li>
                ...
                <span class="tooltip">Cadastrar Turma</span>
            </li>
            <li>
            ...
            <li>
                ...
                <span class="tooltip">Cadastrar Aluno</span>
            </li>
            <li>
               <a href="<%=request.getContextPath()%>/listar-alunos" target="_self">
                ...
                <span class="tooltip">Listar alunos</span>
            </li>
            <li>
                ...
                <span class="tooltip">Cadastrar Disciplina</span>
            </li>
            <li>
               <a href="<%=request.getContextPath()%>/listar-disciplinas" target="_self">
                ...
                <span class="tooltip">Listar Disciplina</span>
            </li>
            <li>
                ...
                <span class="tooltip">Cadastrar Professor</span>
            </li>
            <li>
